...
<div class="lol">
    ...
    <div class="letra">
       <h1>Permisos de Licencias</h1></div>
<style>
        table {
            width: 99%;
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        saveChangesButton.addEventListener('click', function () {
            ...
            window.location.href = `generar_pds.php?id=${personaId}&fechaInicio=${fechaInicio}&fechaFin=${fechaFin}&motivo=${motivo}&condicionPermiso=${condicionPermiso}&nombreAutoridad=${nombreAutoridad}&cedulaAutoriza=${cedulaAutoriza}`;
            Swal.fire({
                icon: 'success',
                title: 'Éxito',

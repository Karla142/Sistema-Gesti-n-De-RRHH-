...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("SELECT id, contrasena, correo FROM usuarios WHERE usuario = ?");
    ...
    if ($stmt->num_rows > 0) {
        $stmt->bind_result($id_usuario, $hashed_password, $correo);
        $stmt->fetch();
...
<body>
    ...
    <img src="edupal.png" width="160" height="100" alt="" border="0"/>
    </div></div>

    <form id="login-form" method="post" action="olvidaste.php">    
  <br>
    <div class="group">
